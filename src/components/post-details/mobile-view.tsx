                        ...
                        <Row className="mt-1 gy-3">
                            <Col xs={12}>
                                <Row className="gy-2">
                                    ...
                                    <Col sm={3} xs={5} className="d-flex justify-content-evenly align-items-center">
                                    ...
                                    <Col xs ={12}>
                                        Est reprehenderit id elit Lorem dolore adipisicing occaecat. 
                                        Commodo do proident eiusmod sit do anim. Culpa laborum id nulla 
                                        laborum labore qui esse laboris commodo.
                                    </Col>
                                </Row>
