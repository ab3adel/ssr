                ...
                <Row className="gy-2">
                  <Col
                    ...
                    onClick={() =>
                      setChecked((pre: any) => ({
                        ...pre,
                        profile_photo_as_image: !checked.profile_photo_as_image,
                      }))
                    }
                  >
                    <Row>
                ...
                <Row className="gy-2">
                  ...
                  <Col xs={12}>
                    <Tabs
                      ...
                      name="property_type_id"
                      mainTabSelected={values["main_property_id"]}
                  ...
                  <Row className="gy-2">
                    ...
                    <Col
                      ...
                      onClick={() =>
                        setChecked((pre: any) => ({
                          ...pre,
                          profile_photo_primary: !checked.profile_photo_primary,
                        }))
                      }
                    >
                      <Row>
